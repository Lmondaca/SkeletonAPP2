...
// navegador (ng serve), así que listarMovimientos() siempre falla y la lista
// queda vacía. No es posible probar "lista con datos" ni "eliminar" de punta
// a punta sin una base de datos real o un dispositivo nativo; estas pruebas
// cubren el comportamiento que sí es real y determinista en el navegador.
...
describe('Movimientos', () => {
  ...
  it('muestra la lista vacía y los totales en 0 cuando no hay datos disponibles', () => {
    ...
    cy.contains('No hay movimientos para el periodo seleccionado.').should('be.visible');
  });
